...
#
#rt HADOOP_ALLOW_SECURE_MODE=true
#i
...
export HDFS_NAMENODE_USER=huser
export HDFS_DATANODE_USER=huser
export HDFS_SECONDARYNAMENODE_USER=huser
export YARN_RESOURCEMANAGER_USER=huser
export YARN_NODEMANAGER_USER=huser
export HADOOP_ALLOW_SECURE_MODE=true
